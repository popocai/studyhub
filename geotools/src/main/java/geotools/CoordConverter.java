...
public class CoordConverter {
    public static double[] convert(double lon, double lat)
        ...
        Coordinate c2 = new Coordinate(113, 23);
        Point p2Src = geoFactory.createPoint(c2);
        Point p2 = (Point) JTS.transform(p2Src, transform);

        System.out.println(p2.distance(targetPoint));
